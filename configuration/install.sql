...
CREATE TABLE `worklogs` (
  ...
  `billing_work_begin` datetime DEFAULT NULL,
  `billing_work_end` datetime DEFAULT NULL,
  `hide_in_billing` enum('yes','no') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
  `event_id` int unsigned DEFAULT NULL,
